...
* Os alunos devem ter conhecimentos essenciais sobre redes IP e ser capazes de escrever software usando *sockets*, se for necessário.## ISEL - Instituto Superior de Engenharia de Lisboa
...
#### Pré-requisitos
* Pelo menos dois semestres de experiência de programação, em qualquer linguagem imperativa ou funcional.
